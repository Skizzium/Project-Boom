...
public class TNTx500Renderer extends PB_AbstractTNTRenderer<PB_PrimedTNT> {
    public TNTx500Renderer(EntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    public PB_TNTBlock getBlock() {
        return PB_Blocks.TNT_X500.get();
    }
}
